...
* Provide a standardized common working environment for data scientistsand DevOps engineers. We want to build using the same tools we'll use for deployment as much as possible.
